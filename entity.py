...
class Entity:
	...
	def __init__(self, x, y, char, color, blocks=False, render_order=RenderOrder.CORPSE, fighter=None, ai=None, item=None, inventory=None, stairs=None, level=None, equipment=None,
		equippable=None, caster=None, stats=None, defender=None, skills=None, melee_weapon=None, missile_weapon=None, name=None, identified=None, consumable=None, ammunition=None, performer=None):
		self.x = x
		self.y = y
		self.char = char
		self.color = color
		...
		if self.ammunition:
			self.ammunition.owner = self
		if self.performer:
			self.performer.owner = self
