...
class Equippable:
	def __init__(self, slot, DR_bonus=0, PD_bonus=0, max_hp_bonus=0, two_handed=False, quantity=0, isShield=False, weight=1, missile_damage_bonus=0):
		self.slot = slot
...
class EquippableFactory:
	...
	def makeAxe(x=1, y=1):
		...
		axe_melee_weapon = MeleeWeapon(WeaponTypes.AXE, "swing", 2, DamageTypes.CUTTING, min_strenght=12)
	...
	def makeDagger(x=1, y=1):
		...
		dagger_melee_weapon = MeleeWeapon(WeaponTypes.DAGGER, "thrust", 0, DamageTypes.IMPALING, min_strength=7)
	...
	def makeBroadSword(x=1, y=1):
		...
		sword_melee_weapon = MeleeWeapon(WeaponTypes.SWORD, "swing", 1, DamageTypes.CUTTING, min_strength=11)
	...
	def makeGreatSword(x=1, y=1):
		...
		greatsword_melee_weapon = MeleeWeapon(weapon_type = WeaponTypes.SWORD, melee_attack_type="swing", melee_damage_bonus=3, melee_damage_type=DamageTypes.CUTTING, min_strength=14)
	...
	def makeRapier(x=1, y=1):
		...
		rapier_melee_weapon = MeleeWeapon(weapon_type=WeaponTypes.SWORD, melee_attack_type="thrust", melee_damage_bonus=1, melee_damage_type=DamageTypes.IMPALING, min_strength=10)
	...
	def makeBow(x=1, y=1):
		...
		bow_missile_weapon = MissileWeapon(weapon_type=WeaponTypes.CROSSBOW, missile_damage=(1, 1), missile_damage_type=DamageTypes.IMPALING)
	...
	def makeCrossBow(x=1, y=1):
		...
		crossbow_missile_weapon = MissileWeapon(weapon_type=WeaponTypes.CROSSBOW, missile_damage=(1, 3), missile_damage_type=DamageTypes.IMPALING)
	...
	def makeSmallShield(x=1, y=1):
		small_shield_equippable = Equippable(EquipmentSlots.OFF_HAND, PD_bonus=1, isShield=True, weight=10)
	...
	def makeShield(x=1, y=1):
		shield_equippable = Equippable(EquipmentSlots.OFF_HAND, PD_bonus=2, isShield=True, weight=15)
	...
	def makeTowerShield(x=1, y=1):
		towershield_equippable = Equippable(EquipmentSlots.OFF_HAND, PD_bonus=3, isShield=True, weight=20)
	...
	def makePaddedArmor(x=1, y=1):
		padded_armor_equippable = Equippable(EquipmentSlots.BODY, PD_bonus=0, DR_bonus=1, weight=6)
	...
	def makeLeatherArmor(x=1, y=1):
		leather_armor_equippable = Equippable(EquipmentSlots.BODY, PD_bonus=1, DR_bonus=1, weight=12)
	...
	def makeChainArmor(x=1, y=1):
		chain_armor_equippable = Equippable(EquipmentSlots.BODY, PD_bonus=2, DR_bonus=2, weight=25)
	...
	def makeScaleArmor(x=1, y=1):
		scale_armor_equippable = Equippable(EquipmentSlots.BODY, PD_bonus=3, DR_bonus=3, weight=35)
	...
	def makePlateArmor(x=1, y=1):
		plate_armor_equippable = Equippable(EquipmentSlots.BODY, PD_bonus=3, DR_bonus=5, weight=50)
